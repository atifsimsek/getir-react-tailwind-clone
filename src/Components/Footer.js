      ...
      <div className=" bg-white mt-8 pb-6">
        <div className="container mx-auto  ">
          <div className="grid  md:grid-cols-2 lg:grid-cols-5 gap-5 pt-10">
            <section>
              <h6 className="text-lg text-primary-brand-color pb-4">
                Getir'i İndirin
              </h6>
            ...
            <div className="hidden lg:flex justify-end">
              <a
                className="bg-white rounded-lg w-[104px] h-[116px] p-4 shadow"
                href="/"
              >
                <img
      ...
      <div className=" bg-gray-50 md:bg-white md:border-t border-gray-150  py-6 ">
        <div className="container mx-auto flex justify-between flex-col md:flex-row items-center ">
          <div className="md:flex-row text-xs text-gray-700 flex flex-col items-center justify-center gap-2 mb-2  gap-x-8">
            &copy;2022 Getir
            <a
              className="text-xs pl-2  text-primary-brand-color before:hidden before:md:block  hover:underline relative before:w-[3.5px] before:h-[3.5px] before:bg-black before:absolute before:-left-4 before:top-1/2 before:rounded-full before:-translate-y-1/6"
              href="/"
            >
          ...
          <nav className="flex flex-col md:flex-row gap-2.5">
            ...
            <div>
              <button
                ...
                className="h-8 flex transit bg-white md:bg-none shadow  md:shadow-none  items-center px-2 text-sm gap-x-2 rounded-md text-gray-500 border border-gray-150 transition-colors hover:bg-primary-brand-color hover:bg-opacity-10 hover:text-primary-brand-color hover:border-transparent"
                href="/"
              >
                <BiGlobe size={18} />
                Türkçe (TR)
