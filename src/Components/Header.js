  ...
  return (
    <>
        ...
        <div className=" container mx-auto h-16 md:h-11  flex items-center justify-center md:justify-between">
          ...
          <nav className=" hidden md:flex gap-x-6 lg:gap-x-8 -mr-10 lg:-mr-0 ">
            <button
              ...
              className=" flex gap-x-2 text-white transition-all text-sm font-semibold opacity-80 hover:opacity-100 "
            >
              <BiGlobe size={20} />
            ...
            <button
              ...
              className="cursor-pointer flex gap-x-2 text-white transition-all text-sm font-semibold opacity-80 hover:opacity-100 "
            >
              <HiUser size={20} />
              <span className="hidden lg:inline">
                {language === "tr-TR" || language === "tr"
      ...
      <div className="md:hidden bg-white mx-auto px-1.5 py-2.5 flex items-center justify-between">
        ...
        <MdArrowForwardIos
          className="text-primary-brand-color mr-0.5 "
          size={16}
        />
      </div>
    </>
