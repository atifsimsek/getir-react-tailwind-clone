...
const Header = () => {
  return (
    <>
      <div className='sticky top-0 z-50 bg-brand-color flex items-center justify-center '>
        <div className=' container mx-auto h-16 md:h11  flex items-center justify-center md:justify-between'>
          ...
          <nav className=' hidden md:flex gap-x-8 '>
            <a className=' flex gap-x-2 text-white transition-all text-sm font-semibold opacity-80 hover:opacity-100 ' href="/">
              <BiGlobe size={20} />
              Türkçe
            </a>
            <a className=' flex gap-x-2 text-white transition-all text-sm font-semibold opacity-80 hover:opacity-100 ' href="/">
