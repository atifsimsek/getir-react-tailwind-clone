  ...
  return (
    <OutsideClick modalRef={modalRef}>
      <div className="fixed  z-50 w-full h-screen inset-0 flex items-center justify-center  bg-black bg-opacity-40 ">
        <div
          ref={modalRef}
          className="w-[446px] h-[300px] gap-8 justify-center relative flex flex-col items-center p-7 rounded-lg shadow-md  bg-white "
        >
          <h6 className="w-full text-center text-sm font-semibold text-primary-brand-color">
            Dil Değiştir
          </h6>
          <button
            onClick={() => {
            ...
            <div className="flex items-center rounded-lg justify-between px-2 py-1.5 ">
              <div className="flex items-center justify-center">
                <input
                  ...
                  checked={value === "tr" || value === "tr-TR"}
                  className="peer/draft  h-5 w-5 ml-2 transition-all accent-primary-brand-color"
                />
                <label className="text-sm ml-3  text-gray-700 peer-checked/draft:text-primary-brand-color ">
                  Türkçe
                </label>
              </div>
              <img
            ...
            <div className="w-full flex items-center justify-between px-2 py-1.5 border-t-2 border-gray-100 ">
              <div className="flex items-center justify-center">
                <input
                  ...
                  checked={value === "en" || value === "en-Us"}
                  type="radio"
                  className="peer/draft  h-5 w-5 ml-2  accent-primary-brand-color cursor-pointer"
                />
                <label className="text-sm ml-3  text-gray-700 peer-checked/draft:text-primary-brand-color ">
                  English
                </label>
          ...
          <button
            ...
            disabled={isDisabled}
            className=" disabled:cursor-no-drop enabled:bg-primary-brand-color enabled:hover:bg-secondary-brand-color cursor-pointer   bg-gray-400  w-full p-3.5 text-sm font-semibold rounded-lg text-white"
          >
            Güncelle
          </button>
        </div>
