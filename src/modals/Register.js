  ...
  return (
    <OutsideClick modalRef={modalRef}>
      <div className="fixed  z-50 w-full h-screen  inset-0 flex items-center justify-center  bg-black bg-opacity-40 ">
        <div
          ref={modalRef}
          className="w-[446px] min-h-[590px] relative flex flex-col items-center pt-10 rounded-lg shadow-md  bg-white "
        >
              ...
              >
                ...
                <label className="display flex items-center  gap-x-3 w-full">
                  <span className="mt-1.5 relative">
                    ...
                    <BiCheck
                      size={24}
                      className="text-white absolute -top-[1.5px] -left-[1.5px]"
                    />
                  </span>
                  <span className="text-xs leading-5 cursor-pointer text-gray-400">
                    Getir’in bana özel kampanya, tanıtım ve fırsatlarından{" "}
                    <br /> haberdar olmak istiyorum.
                  </span>
                </label>

                <p className="text-xs text-gray-400 leading-5  ">
                  Kişisel verilerinize dair Aydınlatma Metni için{" "}
                  <span className="text-primary-brand-color underline">
                    tıklayınız.
                  </span>{" "}
                  Üye olmakla,{" "}
                  <span className="text-primary-brand-color underline">
                ...
                <div className="w-full absolute bottom-0 left-0 right-0 rounded-b-lg">
                  <div className="px-5  mb-5">
                    <button
                      type="submit"
                      className="w-full rounded-lg h-11 text-white hover:bg-secondary-brand-color text-sm font-semibold  bg-primary-brand-color"
                    >
                      Kayıt Ol
                    </button>
                  </div>
                  <div className="h-14 bg-gray-100 rounded-b-lg flex items-center justify-center">
                    <p className="text-gray-500 opacity-90  text-sm ">
                      Getir'e üyeyseniz{" "}
                      <span className="text-primary-brand-color text-sm font-semibold">
                        Giriş yap
                      </span>
                    </p>
                  </div>
